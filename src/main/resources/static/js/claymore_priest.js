...
var updatePriestAbilities = function() {
...
//	}
	var priestAbilities = getPriestRamifyingLevelAbilities();
	$('#priest_ramifying_level').text(character.ramifyingLevel);
	$('#character_charge_percent').text(character.chargePercent+"%");
	$('#priest_sign_count').text(priestAbilities.signs);
	$('#priest_wonder_count').text(priestAbilities.wonders);
