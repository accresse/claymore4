...
<body>
  <nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="container">
      <a class="navbar-brand" href="#"><i class="fa d-inline fa-lg fa-address-book"></i><b class="m-1">Claymore</b></a>
      ...
      <div class="row">
        <div class="col-md-12">
        		...
        		<c:forEach items="${characters}" var="character">
        			<li><a href="character/${character.characterId}">${character.name}</a> (${character.player.userName})</li>
        		</c:forEach>
        		</ul>
        </div>
      </div>
